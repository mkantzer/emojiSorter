...
// // isPredefined checks if an emoji name is one of the predefined ones
// func isPredefined(name string) bool {
// 	if _, ok := emojiCodeMap[name]; ok {
// 		return true
// 	}
// 	return false
// }
...
func emojiCode() map[string]string {
	emojiCodeMapInitOnce.Do(func() {
		zap.S().Info("initializing emoji map")
...
func emojiRevCode() map[string][]string {
	emojiRevCodeMapInitOnce.Do(func() {
		zap.S().Info("initializing emoji reverse map")
